...
**(d) Verification Data.** In order for us to verify that a User is not a bot, we may use phone verification procedures. This applies only when and if you are accessing an Ad and does not apply to Surveys. Before you access an Ad, you may be requested to voluntarily provide your phone number. You will then be sent a sms, as part of our user-verification procedure. We will not share your phone number with any client of ours.  
...
In the case mentioned above, Pollfish will be sharing with Collaborating Advertisers only Automatically Received Data. Pollfish does not and will not share with Collaborating Advertisers any Survey Data (data collected through any survey process, including collected sociodemographic data about a User). 
...
**Data collected through the Market-Survey Process (&quot;Content Data&quot;)**
...
**We will not share your phone number with any client of ours.**  However, please note that we may share such data with certain other recipients, in accordance with Section 6 (c) – (f) and Section 7 of this Policy.
...
**5.2 Survey Data.** Whenever a User is served a Survey, the User is also asked to affirmatively accept this Policy, before taking any Survey.


**6. LEGAL BASES FOR PROCESSING, FURTHER PROCESSING ACTIVITIES AND FURTHER RECIPIENTS.**

**6.1**  Pollfish collects, stores and processes your personal data for the following purposes:

**(a)** to be able to present to you Offers via collaborating apps, including in order to discern survey tendering eligibility and tender surveys to you. We may correlate, associate and analyse collected data and proceed to market profiling or other statistical processing and sociodemographic grouping. [Legal basis of processing activity: Your Consent].

**(b)** to provide services and execute our contractual obligations towards our clients (the “Pollfish Clients”). The term “Pollfish Clients” means (a) Researcher Clients (b) Collaborating Advertisers (c) Mediation Partners (d) the Other Pollfish Clients [Legal basis of processing activity: Your Consent].
...
**(e)** for further internal analyses and statistical purposes, related to the interaction between Pollfish and Users [legal basis of processing: legitimate interests]

**(f)** to answer to your requests and satisfy your data protection related rights [legal basis of processing: Legal or regulatory obligation]

**6.2**  We will only use your personal data for the purposes for which we collected it as detailed in Sections 3 and 6.1 above. If we need to use your personal data for an unrelated purpose, we will notify you and we will explain the legal basis which allows us to do so.

**7. DISCLOSURES OF YOUR PERSONAL DATA**

**7.1**  We disclose or may disclose your personal data to the following data-recipients:

| **DATA RECIPIENT** | **TYPE OF DATA SHARED** | **PURPOSE** |
| --- | --- | --- |
| Researcher Clients | -Automatically Received Data <br/> -Survey Data (Sociodemographic + Content Data) | Provision of services |
| Mediation Partners | -Automatically Received Data <br/> - Sociodemographic Data | Provision of services |
| Collaborating Advertisers | Automatically Received Data | Provision of services |
| Other Pollfish Clients | -Automatically Received Data <br/> - Sociodemographic Data | Provision of services |
| Cloud Service Providers | -Automatically Received Data <br/> -Survey Data (Sociodemographic + Content Data) <br/> -Communication Data <br/> -Verification Data | Data Hosting and Data Management |
| Suppliers of Analytics Services (such as Google analytics) | -Automatically Received Data | Analytics |
| Lawyers | -Automatically Received Data <br/> -Survey Data (Sociodemographic + Content Data) <br/> - Communication Data <br/> - Verification Data | Protection of legal interests |
| State Authorities | -Automatically Received Data <br/> -Survey Data (Sociodemographic + Content Data) <br/> -Communication Data <br/> - Verification Data | Compliance with regulatory and legal obligations |
| Security, safety and anti-fraud service providers | -Automatically Received Data <br/> - Sociodemographic Data <br/> - Verification Data | Protection of legal interests, protection of client interests, security, anti-fraud |
| External auditors | -Automatically Received Data <br/> - Sociodemographic Data <br/> -Communication Data <br/> - Verification Data | Regulatory, contractual and legal compliance |
| Pollfish Headquarters located in the US, Affiliates | -Automatically Received Data <br/> - Survey Data <br/> -Communication Data <br/> -Verification Data | Internal business organization and management |
| Mailing and communication service providers | Communication Data | Communication
...
**7.5**  By accepting this Privacy Policy you grant your consent for the sharing of your data as described in this section 7. However, you can at all times withdraw your consent with regards to any data-sharing based on your consent, by using the opt-out options provided to you under section 8 of this Policy or by submitting a request under section 14 of this Policy.
...
Pollfish complies with the CCPA (California Consumer Privacy Act) Pollfish has decided to incorporate CCPA requirements in its general policies and use a uniform set of rules for all Users irrespective of their place of residence. Therefore, the information provided in this section applies for California as well as for non-California residents alike.

Please note that under the CCPA, categories of personal information are grouped under certain titles explained in section 11.1 below.

**Please note that a YES marking to the categories of data under section 11.1 only indicates that Pollfish may collect and process some (and not all) data falling under these categories, solely according to the detailed description of data we collect under section 3 of this Policy.
 For example, a &quot;Yes&quot; marking in the Category &quot;Identifiers&quot; only suggests that we may collect and process your IP address or Device ID (as described in section 3.1 of this Policy) but we do not collect or process your full name, e-mail etc (as also explained in Sections 3 and 4 of this Policy).**

**11.1 Information We Collect and notifications according to the CCPA**

Information we collect is described in detail in section 3 of this Policy. We will be updating this table every 12 months. Within the last twelve months we have collected and shared the following CCPA grouped categories of personal information about Users:
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| A. Identifiers. Examples: A real name, alias, postal address, unique personal identifier, online identifier, Internet Protocol address, email address, account name, Social Security number, driver&#39;s license number, passport number, or other similar identifiers. | YES (only  anonymous Automatically Received data and Sociodemographic Data) | - From App-Publishers - Directly from Users (including Pollfish Survey Respondents answering a Pollfish Internal Sociodemographic Survey (as regards Sociodemographic Data) | YES | YES | - to Researcher Clients - to Mediation Partners - To Collaborating Advertisers - To a certain &quot;Other Client&quot; engaging in Digital threat management - To a certain 3rd party data marketplace/data exchanger | YES | Suppliers of following services: - Cloud hosting - legal services - Analytics services - Anti-fraud services - mailing and communication services - affiliates |
| B. Personal information categories listed in the California Customer Records statute (Cal. Civ. Code § 1798.80(e)). A name, signature, Social Security number, physical characteristics or description, address, telephone number, passport number, driver&#39;s license or state identification card number, insurance policy number, education, employment, employment history, bank account number, credit card number, debit card number, or any other financial information, medical information, or health insurance information. Some personal information included in this category may overlap with other categories. | YES(only as regards **anonymous**  education, medical info, financial info, health insurance info and employment info and only insofar and to the extent that a Pollfish Survey Respondent answers related Pollifsh Researcher Client Survey questions and/or a Pollfish Internal Sociodemographic Survey) | - Directly from Pollfish Respondents answering a related survey question | YES | YES | -to Researcher Clients - to Mediation Partners \* - To a certain &quot;Other Client&quot; engaging in Digital threat management \* - To a certain 3rd party data marketplace/data exchanger \* | YES | Suppliers of following services: - Cloud hosting - legal services - Analytics services - Anti-fraud services - mailing and communication services - affiliates |
