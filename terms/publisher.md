...
Publishers or Networks that use Pollfish with an API integration and not with the standard SDK integration will be paid in Net40. All Referral prices are displayed in USD and may be found in https://www.pollfish.com/referral Polllfish Inc. is a registered US company. All publisher payments occur in US currency. Notifications/listeners fired from the SDK within the apps to inform the user about the money to be earned from a survey are delivered in USD.
