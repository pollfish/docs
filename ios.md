...
| Other User Content | Any other user-generated content | YES | Different types of open ended questions might be asked in surveys |
|  **Browsing History** | --- | --- | --- |
...
|  **Other Data** | --- | --- | --- |
| Other Data Types | Any other data types not mentioned | YES | Different data that are collected through surveys |
