...
<br/><br/>
and on **App Store Connect** in the App's Privacy Policy, update the relevant data collection questionnaire with the following choices as suggested by the latest AppStore's policies:
<br/>
