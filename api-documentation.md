...
|71 | **content_type** | String | If it is set to "json" returns offerwall response with HTTP 200 in json format. If no surveys are found returns 204 with empty body. Requires offerwall parameter to be true. If is set to "html" or ommited defaults to offerwall behavior. |  "json" / "html" | No | No
...
|  | Key                   | Name                      | Value
|--|:----------------------|:--------------------------|:----------
|58| **organization_role** | OWNER_PARTNER             | 0
