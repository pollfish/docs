...
|71 | **click_id** | String | A value as a String that you want to get back on the S2S callback |  "aRandomClickId" | No | No
</br>
...
Note 1: If you want to receive a value that you will sent on device_register
and get back on S2S callback you can use the "click_id" parameter.
