...
<br/>
<img style="margin: 0 auto; display: block;" src="https://storage.googleapis.com/pollfish-images/targeting.png"/>
<br/>


In our efforts to include publishers in this process and be as transparent as possible  we provide full control over the process, letting publishers decide if their users are served these surveys or not by monitoring the process in code and excluding any users by monitoring the relevant noitifications in code, by the Pay Per Survey (PPS) 0 cents notification. Bear in mind that by filtering out all surveys with PPS 0 will also deny you the possibility of running any free internal surveys, since they also have a PPS of 0.
