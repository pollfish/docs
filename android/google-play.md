...
**At this point you are ready to go live! Sign your app with a release key OR explicitly setReleaseMode(true) in your ParamsBuilder and publish to any app store**
