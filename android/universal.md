...
<br/><br/>
#### A. Add dependency to Pollfish and Google Play Services libraries in your build.gradle file
```java
dependencies {
...
#### B. Initialize Pollfish in your activity
...
#### C. Add internet permission in your AndroidManifest.xml file
