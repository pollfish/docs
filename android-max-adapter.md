...
> **Note:** Prodege SDK requires minSdk 21. If your app supports a lower minSdk you can still build your app.
...
**`muted`** <br/> TogglesProdege video ads mute state | Bool | No
...
Next, fill the CPM Price field with a value ranging between $70-$80 since Prodege rewarded ads eCPMs usually fluctuates in that range.
...
Click [here](https://storage.googleapis.com/pollfish_production/sdk/AppLovin/Pollfish%20Max%20Adapter%20Android-6.4.0.0.zip) to download the latest version of Prodege Android Max Adapter SDK.
...
If everything worked fine during the previous steps, you are ready to procceed with publishing your app.
