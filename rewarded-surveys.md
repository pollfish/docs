...
> **Note:** On Android and iOS there is also an optional function that you can call in order to see if a survey is present on the device (did not expire) and prior calling Pollfish show.
